...
class VehiculoStoreRequest extends FormRequest
{
    ...
    {
        return [
            'nom' => 'min:5|max:20|regex:/^[\pL\s]+$/u|required:vehiculos,nom',
            'placa' => 'min:7|max:8|alpha_num|required|unique:vehiculos,placa',
            'marca' => 'nullable|max:20:vehiculos,marca',
            'modelo' => 'nullable|max:20:vehiculos,modelo',
            'rfid' => 'max:30|unique:vehiculos,rfid',
        ];
    }
    ...
    {
        return [
            'nom.regex'=>'El nombre del vehiculo solo debe contener letras, no numeros.',
             'nom.min'=>'El nombre del vehiculo debe contener al menos 5 letras',
            'nom.max'=>'El nombre del vehiculo debe contener  20 letras',
            ...
            'rfid.max'=>'El nombre debe contener mas 30 digitos ',
        ];
    }
}
