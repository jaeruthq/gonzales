...
class DatosUsuarioStoreRequest extends FormRequest
{
    /**
    ...
    {
        return [
			'nom' => 'min:3|max:20|regex:/^[\pL\s]+$/u|required:datos_usuarios,nom',
            'apep' => 'min:3|max:20|alpha:datos_usuarios,apep',
            'apem' => 'nullable|max:20|alpha:datos_usuarios',
            'ci' => 'min:7|max:10|unique:datos_usuarios,ci',
            'fono' => 'nullable|max:8:datos_usuarios,fono',
            'cel' => 'min:8|max:8:datos_usuarios,cel',
        ];
    }
    ...
    public function messages()
    {
        return [
           ...
           'nom.regex' => 'El nombre del usuario solo debe contener letras, no numeros',
