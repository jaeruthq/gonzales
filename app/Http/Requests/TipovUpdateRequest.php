...
class TipovUpdateRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            //
            'nom' => 'min:4|max:20|regex:/^[\pL\s]+$/u|required:tipo_vehiculos,nom,'.$this->tipo->id,
            'descripcion' => 'nullable|max:50:tipo_vehiculos,descripcion,'.$this->tipo->id,
        ];
    }
